...
public class RandomImageUtils {
    ...
    public static  void outImage(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (org.apache.commons.lang3.StringUtils.isNumeric(width) && StringUtils.isNumeric(height)) {
            w = NumberUtils.toInt(width);
            h = NumberUtils.toInt(height);
        }
